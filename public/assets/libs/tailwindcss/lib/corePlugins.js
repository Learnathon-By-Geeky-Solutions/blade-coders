...
const _createUtilityPlugin = /*#__PURE__*/ _interop_require_default(require("./util/createUtilityPlugin.js"));
const _buildMediaQuery = /*#__PURE__*/ _interop_require_default(require("./util/buildMediaQuery.js"));
const _escapeClassName = /*#__PURE__*/ _interop_require_default(require("./util/escapeClassName.js"));
const _parseAnimationValue = /*#__PURE__*/ _interop_require_default(require("./util/parseAnimationValue.js"));
const _flattenColorPalette = /*#__PURE__*/ _interop_require_default(require("./util/flattenColorPalette.js"));
const _withAlphaVariable = /*#__PURE__*/ _interop_require_wildcard(require("./util/withAlphaVariable.js"));
const _toColorValue = /*#__PURE__*/ _interop_require_default(require("./util/toColorValue.js"));
const _isPlainObject = /*#__PURE__*/ _interop_require_default(require("./util/isPlainObject.js"));
const _transformThemeValue = /*#__PURE__*/ _interop_require_default(require("./util/transformThemeValue.js"));
const _packagejson = require("../package.json");
const _log = /*#__PURE__*/ _interop_require_default(require("./util/log.js"));
const _normalizeScreens = require("./util/normalizeScreens.js");
const _parseBoxShadowValue = require("./util/parseBoxShadowValue.js");
const _removeAlphaVariables = require("./util/removeAlphaVariables.js");
const _featureFlags = require("./featureFlags.js");
const _dataTypes = require("./util/dataTypes.js");
...
let variantPlugins = {
    ...
    screenVariants: ({ theme , addVariant , matchVariant  })=>{
        ...
        /**
     * @typedef {import('./util/normalizeScreens.js').Screen} Screen
     */ /**
     * @param {'min' | 'max'} type
