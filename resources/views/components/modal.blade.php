...
<div class="fixed inset-0 z-50 overflow-y-auto px-4 py-6 sm:px-0" style="display: {{ $show ? 'block' : 'none' }};"
    ...
    <div class="{{ $maxWidth }} fixed inset-x-0 top-1/2 mb-6 -translate-y-1/2 transform overflow-hidden rounded-lg bg-white shadow-xl transition-all sm:mx-auto sm:w-full"
